...
This application processes the log files generated by the Stata Runner App for the 5% data sample, censors sensitive information, and moves the processed log files to a designated directory.
